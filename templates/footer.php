<!-- FOOTER -->
  ...
  <!-- Seção do rodapé -->
    ...
    <div class="container-fluid" id="footer-links-container">
        ...
        <!-- Linha que contém três colunas de links -->
            ...
            <div class="col-12 col-md-4 footer-column" id="footer-center">
                ...
                <p class="store-phone"><i class="bi bi-telephone"></i> (11)98567-5598</p>
            </div>
        ...
        <div class="col-12">
            <div class="row">
                ...
                <form class="d-flex" id="news-form">
                    <i class="bi bi-envelope secondary-color"></i>
                    <input class="form-control me-2" placeholder="Insira seu e-mail">
                    <button class="btn secondary-bg-color" type="submit" id="button-newsletter">Enviar</button>
                </form>
            </div>
        </div>
    ...
    <div class="container-fluid" id="copy-container">
        <p>Todos os direitos reservados @2023 <span style="color:#508696;">The Booktown</span> - Your place to read</p>
    </div>
